  ...
  return (
    ...
    transition={{
     ...
     className="relative flex justify-center items-center">
        ...
        <div className="absolute border border-[#0c5d28] rounded-full h-[600px] w-[600px] mt-52 animate-ping" />
        <div className="rounded-full border border-[#0c5d28] opacity-20 h-[650px] w-[650px] absolute mt-52 animate-pulse" />
